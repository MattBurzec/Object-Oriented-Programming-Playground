...
objectCreatedFromExample.myVariable = "Wow Make School is great"
anotherExampleObject.myVariable = "Another example will help"
...
class Tiger {
    ...
    func eat(food: String) {
        ...
        if food == "meat" {
            ...
            print("YUM! Tigger wants more meat")
            if food == "kiddo"  {
                print("\(name), eats kiddo")
            }
            else {
                print(food)
            }
